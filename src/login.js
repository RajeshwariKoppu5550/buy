...
function Login() {
    return (
        <div>
            <div>
                <div className="font-[sans-serif]  text-gray-800" style={{
                    backgroundImage: "url('http://www.tapeciarnia.pl/tapety/normalne/tapeta-pizza-z-wedlina-i-pieczarkami.jpg')",
                        ...
                        <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
                            <div>
                                ...
                                <p className="text-sm mt-6 text-white">
                                    ...
                                    <Link to="/Sign-up"> <a href="javascript:void(0);" className="text-white font-semibold underline ml-1"></a></Link>
                                </p>
                            </div>
                            ...
                            <form className="bg-white rounded-xl px-6 py-8 space-y-6 max-w-md md:ml-auto w-full">
                                ...
                                <div>
                                    <Link to="/home"><button type="button" className="w-full shadow-xl py-3 px-6 text-sm font-semibold rounded-md text-white bg-gray-800 hover:bg-[#222] focus:outline-none">Log in</button></Link>
                                </div>

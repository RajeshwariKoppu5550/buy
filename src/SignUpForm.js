                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <label htmlFor="remember-me" className="ml-3 block text-sm text-gray-800">
                                        I accept the
                                        <a href="javascript:void(0);" className="text-blue-600 font-semibold hover:underline ml-1">Terms and Conditions</a>
                                    </label>
                                </div>
                            </div>

                            <div className="mt-12">
                                <Link to="/login"><button type="button" className="py-4 px-8 text-sm font-semibold text-white tracking-wide bg-blue-600 hover:bg-blue-700 focus:outline-none">
                                    Create an account
                                </button></Link>
                            </div>
                            <p className="text-sm text-gray-800 mt-6">
                                Already have an account?
                                <Link to="/login"><a href="javascript:void(0);" className="text-blue-600 font-semibold hover:underline ml-1">Login here</a></Link>
                            </p>
                        </form>
